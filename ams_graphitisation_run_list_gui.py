...
class GraphitisationRunListWindow(QWidget):
    ...
    def _check_privileges(self):
        try:
            ...
            self.has_write_priv = check_employee_privilege(u, "accessgraphitisation")
            self.has_admin_priv = check_employee_privilege(u, "graphitisationadmin")
        except Exception as exc:
    ...
    def load_run_list(self):
        ...
        for row in rows:
            status_code = int(row[6]) if row[6] is not None else 0
